...
const qnaList = [
    ...
    },
    {
      ...
      a: [
        {answer: '산은 산이요. 물은 물이로다. 있는 그대로 본다.', type: '1', score: '3'},
        {answer: '현실보다는 나만의 세계, 상상의 나래를 펼친다.', type: '2', score: '5'},
      ]
    },
    ...
    },
    {
      ...
      q: '화가 났을 때 나의 첫 반응은?',
      a: [
        {answer: '"야. 봐 봐?" 이성적으로 판단하여 차분히 말한다.', type: '1', score: '3'},
    ...
    },
    {
      ...
      a: [
        {answer: '현실적인 해결책을 제시하고 응원한다.', type: '1', score: '3'},
        {answer: '감정을 공감하고 정신적인 지지를 해준다.', type: '2', score: '5'},
      ]
    },
    {
      which: 'TF',
      q: '좋아하는 사람과 대화할 때 나는?',
      a: [
        {answer: '질문으로 상대방에 대해 물어보고 궁금해한다.', type: '1', score: '3'},
        {answer: '그 사람이 대화할 때 리액션하며 공감한다.', type: '2', score: '5'},
      ]
    },
    {
      which: 'JP',
      ...
      a: [
        {answer: '요일별로 세부일정을 계획한다.', type: '1', score: '3'},
        {answer: '비행기 표 예매 완료~! 계획은 거의 끝났다고 본다.', type: '2', score: '5'},
      ]
    },
    {
      which: 'JP',
      q: '나랑 더 가까운 것은?',
      a: [
        {answer: '정리정돈을 잘하고 내 물건이 어딨는지 잘 찾는다.', type: '1', score: '3'},
        {answer: '내 물건들은 어디 있는지 잘 안다고 생각하지만, 막상 찾아보면 없다...', type: '2', score: '5'},
      ]
    },
    {
      which: 'JP',
